...
const HospitalAdminDashboard = () => {
    ...
    const handleCreateStaff = async (e) => {
        ...
        try {
            ...
            const userData = { ...createForm, avatar: avatarUrl, departments: ['IVF'] };
    ...
    const tabs = [
        ...
        { id: 'departments', label: '💵 Consultation Fees' },
        ...
        <div className="hospitaladmin-page">
            <div className="hospitaladmin-container">
                ...
                <div style={{ marginBottom: '32px' }}>
                    ...
                    <p style={{ color: '#64748b', fontSize: '0.95rem' }}>Manage staff and hospital operations</p>
                </div>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group">
                                            <label className="staff-label">
                                                Phone
                                                {createForm.phone && createForm.phone.length !== 10 && (
                                                    <span style={{ color: 'red', marginLeft: '5px', fontSize: '11px', textTransform: 'none' }}>incorrect phone number</span>
                                                )}
                                            </label>
                                            <input type="text" placeholder="Phone number" value={createForm.phone} onChange={e => setCreateForm({ ...createForm, phone: e.target.value.replace(/\D/g, '').slice(0, 10) })} className="staff-input" maxLength="10" />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group">
                                        ...
                                        <td>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                ...
                                                <input
                                                    ...
                                                    value={hospitalInfo?.departmentFees?.['IVF'] ?? hospitalInfo?.appointmentFee ?? 500}
                                                    onChange={(e) => {
                                                        const newFee = Number(e.target.value);
                                                        setHospitalInfo(prev => ({
                                                            ...prev,
                                                            departmentFees: { ...(prev.departmentFees || {}), 'IVF': newFee }
                                                        }));
                                                    }}
                                                />
                                            </div>
