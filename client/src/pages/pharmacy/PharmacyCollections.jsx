                ...
                <>
                    <div className="kpi-grid">
                        <div className="kpi-card sales">
                            <h3>Total Sales</h3>
                            <div className="kpi-value">₹{analytics.totalSales.toFixed(2)}</div>
                        </div>
                        <div className="kpi-card refunds">
                            <h3>Total Refunds</h3>
                            <div className="kpi-value">₹{analytics.totalRefunds.toFixed(2)}</div>
                        </div>
                        <div className="kpi-card net">
                            <h3>Net Revenue</h3>
                            <div className="kpi-value">₹{analytics.netRevenue.toFixed(2)}</div>
                        </div>
                        <div className="kpi-card profit">
                            <h3>Gross Profit</h3>
                            <div className="kpi-value">₹{analytics.grossProfit.toFixed(2)}</div>
                            <div className="kpi-subtext">COGS: ₹{analytics.cogs.toFixed(2)}</div>
                        </div>
                    </div>
                            ...
                            <table className="data-table">
                                ...
                                <tbody>
                                    {analytics.topSellingItems.map((item, idx) => {
                                        ...
                                        const maxQty = Math.max(...analytics.topSellingItems.map(i => i.quantity)) || 1;
