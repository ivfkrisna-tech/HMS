...
const Patient = () => {
    ...
    const S = {
        ...
        searchInput: { width: '100%', padding: '11px 16px 11px 42px', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', color: '#1e293b', fontSize: '0.88rem', outline: 'none', transition: 'border 0.2s' },
        searchIcon: { position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#475569', fontSize: '1rem' },
        tabsWrap: { display: 'flex', gap: '4px', background: '#f1f5f9', padding: '4px', borderRadius: '12px', border: '1px solid #e2e8f0' },
        tab: (active) => ({ padding: '8px 20px', borderRadius: '9px', border: 'none', cursor: 'pointer', fontWeight: '700', fontSize: '0.82rem', transition: 'all 0.25s', background: active ? 'linear-gradient(135deg, #3b82f6, #6366f1)' : 'transparent', color: active ? '#fff' : '#64748b', boxShadow: active ? '0 2px 12px rgba(59,130,246,0.3)' : 'none' }),
        ...
        empty: { textAlign: 'center', padding: '60px 20px', background: '#f8fafc', borderRadius: '16px', border: '1px dashed #cbd5e1' },
        // Modal styles
                                            ...
                                            >
                                                ...
                                                <td style={S.td}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                        ...
                                                        <div>
                                                            <div style={{ color: '#1e293b', fontWeight: '700', fontSize: '0.88rem' }}>{apt.userId?.name || 'Walk-in'}</div>
                                                ...
                                                <td style={{ ...S.td, color: '#1e293b', fontWeight: '600', fontSize: '0.85rem' }}>{apt.appointmentTime || '-'}</td>
                                                <td style={{ ...S.td, color: '#64748b', fontSize: '0.82rem' }}>
