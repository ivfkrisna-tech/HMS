                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <small style={{ color: '#888', fontSize: '12px', display: 'block', marginBottom: '10px' }}>
                                The tabs user will see in their sidebar menu. Auto-generated links from permissions are shown with a 🔒.
                            </small>
                            {getAutoNavLinks(formData.permissions).map((link, index) => (
                                <div key={`auto-${index}`} className="nav-link-row" style={{ opacity: 0.7 }}>
                                    <input type="text" value={link.label} className="nav-input" disabled title="Auto-generated from permissions" />
                                    <input type="text" value={link.path} className="nav-input" disabled title="Auto-generated from permissions" />
                                    <button type="button" className="btn-remove-nav" disabled style={{ cursor: 'not-allowed', background: 'transparent' }}>🔒</button>
                                </div>
                            ))}
