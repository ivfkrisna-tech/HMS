...
const AdminQuestionLibrary = () => {
    ...
    const fetchLibrary = async () => {
        try {
            ...
            if (!data || Object.keys(data).length === 0) {
                ...
                const cleanData = { "IVF": data["IVF"] || {} };
                data = cleanData;
            }

            setLibraryData(data);
            setDepartmentTab("IVF");

            const firstDeptCats = Object.keys(data["IVF"] || {});
    ...
    const currentCategories = libraryData["IVF"] || {};
