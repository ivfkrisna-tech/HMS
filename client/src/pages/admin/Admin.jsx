                        ...
                        <form onSubmit={handleCreateStaff} className="user-form">
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" placeholder="e.g. 9876543210" value={createForm.phone} onChange={e => setCreateForm({ ...createForm, phone: e.target.value.replace(/\D/g, '').slice(0, 10) })} className="staff-input" maxLength="10" />
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleUpdateUser} className="user-form">
                                ...
                                <div className="form-row">
                                    <div className="form-group">
                                        ...
                                        <input type="text" value={editForm.phone} onChange={e => setEditForm({ ...editForm, phone: e.target.value.replace(/\D/g, '').slice(0, 10) })} className="staff-input" maxLength="10" />
                                    </div>
                                    <div className="form-group">
