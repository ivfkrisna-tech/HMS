...
// MIDDLEWARE: Verify User is a Lab or Doctor (for small clinics)
...
router.post('/upload-report/:reportId', verifyToken, verifyLab, (req, res, next) => {
    ...
    try {
        ...
        const fileResult = await imagekit.upload({
            ...
            fileName: `lab_report_${report.patientId}_${Date.now()}${ext}`,
